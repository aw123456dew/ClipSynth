...
from frame_cut.models.project_state import AnalysisMode, VideoSegment
from frame_cut.services.ai_service import AIService
from frame_cut.services.video_preprocessor import VideoPreprocessor

logger = logging.getLogger("frame_cut.video_analysis")
...
class VideoAnalysisService:
    ...
    def _extract_slice_frames(
        ...
        frame_dir = Path(tempfile.mkdtemp(prefix="frame_cut_slice_"))
